...
<xsl:template match="testResults">
	<html>
		<head>
			<title>Cirrus Sanity Test Results</title>
			<style type="text/css">
				body {
...
<xsl:template name="pageHeader">
	<h1>Cirrus Sanity Test Results</h1>
	<table width="100%">
		<tr>
			<td align="left"></td>
			<td align="right">Login to Application <a href="https://Cirrusqa.innominds.com:9444/Cirrus">QA</a>,, <a href="https://ictoncloud.in/Cirrus">SIT</a>,, <a href="https://ictoncloud.com/Cirrus">UAT</a> Application</td>
		</tr>
	</table>
	<hr size="1" />
</xsl:template>
